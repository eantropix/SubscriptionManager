...
{
    public class StatusConsumerAppService : MessageBrokerConsumerAppService<Status>
    {
        ...
        public StatusConsumerAppService(IRepository<Status> repository, IUnitOfWork unitOfWork, IRepository<EventHistory> eventRepository, IConnectionFactory factory) : base(factory)
        {
